...
public class BookingController {
    ...
    @PostMapping
    public BookingDtoToUser addBooking(@RequestHeader(headerName) long creatorId, @RequestBody @Valid BookingDtoFromUser bookingDtoFromUser) {
    ...
    public BookingDtoToUser updateStatusBooking(@RequestHeader(headerName) long ownerId, @PathVariable long bookingId, @RequestParam boolean approved) {
    ...
    @GetMapping
    public List<BookingDtoToUser> findBookingsCreator(@RequestHeader(headerName) long creatorId, @RequestParam(defaultValue = "ALL") String state ) {
    ...
    @GetMapping("/owner")
    public List<BookingDtoToUser> findOwnerBookings(@RequestHeader(headerName) long ownerId, @RequestParam(defaultValue = "ALL") String state ) {
        userService.getUser(ownerId);
