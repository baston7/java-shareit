...
public interface BookingRepository extends JpaRepository<Booking, Long> {
    ...
    Optional<Booking> findTopByItem_IdAndEndIsAfterAndStatusIsNotAndStatusIsNotOrderByEndDesc(long itemId,
                                                                                              LocalDateTime time,
                                                                                              Status status,
                                                                                              Status status1);

    Optional<Booking> findTopByItem_IdAndEndIsBeforeAndStatusIsNotAndStatusIsNotOrderByEndDesc(long itemId,
                                                                                               LocalDateTime time,
                                                                                               Status status,
                                                                                               Status status1);
}
